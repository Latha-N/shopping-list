              ...
              <ul class="navbar-nav nav-links" id="navbarSupportedContent">
                ...
                <li class="nav-item active mr-5 ml-5">
                  ...
                  <li class="nav-item mr-5">
                      <a class="nav-link  text-dark" href="#">Connections</a>
                  </li>
                
                  <li class="nav-item mr-5">
                      <a class="nav-link" href="#">
                          <span class="fs-3 opacity-25"><FontAwesomeIcon icon={faShoppingBag}/></span>
                      </a>
                  </li>
                <li class="nav-item mr-5">
                      <a class="nav-link d-flex justify-content-start align-items-start" href="#">
                          <span class="fs-3 opacity-25"><FontAwesomeIcon icon={faBell}/></span>
                  ...
                  <li class="navbar-item">
                    <a class="border-left nav-link "><img class="rounded-circle" src={logo2} width="60px" height="60px" /></a>
                    </li>
